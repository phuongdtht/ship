                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('public/Admin_asset')}}/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('public/Admin_asset')}}/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <span class="label label-primary pull-right">4</span>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{asset('public/Admin_asset')}}/pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Boxed</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Fixed</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{asset('public/Admin_asset')}}/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> ChartJS</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/charts/morris.html"><i class="fa fa-circle-o"></i> Morris</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{asset('public/Admin_asset')}}/pages/UI/general.html"><i class="fa fa-circle-o"></i> General</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/UI/icons.html"><i class="fa fa-circle-o"></i> Icons</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/UI/buttons.html"><i class="fa fa-circle-o"></i> Buttons</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/UI/sliders.html"><i class="fa fa-circle-o"></i> Sliders</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/UI/timeline.html"><i class="fa fa-circle-o"></i> Timeline</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/UI/modals.html"><i class="fa fa-circle-o"></i> Modals</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{asset('public/Admin_asset')}}/pages/forms/general.html"><i class="fa fa-circle-o"></i> General Elements</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/forms/editors.html"><i class="fa fa-circle-o"></i> Editors</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{asset('public/Admin_asset')}}/pages/tables/simple.html"><i class="fa fa-circle-o"></i> Simple tables</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/tables/data.html"><i class="fa fa-circle-o"></i> Data tables</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{asset('public/Admin_asset')}}/pages/calendar.html">
              ...
              <small class="label pull-right bg-blue">17</small>
                ...
                <li>
                    <a href="{{asset('public/Admin_asset')}}/pages/mailbox/mailbox.html">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/invoice.html"><i class="fa fa-circle-o"></i> Invoice</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/profile.html"><i class="fa fa-circle-o"></i> Profile</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/login.html"><i class="fa fa-circle-o"></i> Login</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/ages/examples/register.html"><i class="fa fa-circle-o"></i> Register</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/404.html"><i class="fa fa-circle-o"></i> 404 Error</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/500.html"><i class="fa fa-circle-o"></i> 500 Error</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/blank.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                        <li><a href="{{asset('public/Admin_asset')}}/pages/examples/pace.html"><i class="fa fa-circle-o"></i> Pace Page</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
